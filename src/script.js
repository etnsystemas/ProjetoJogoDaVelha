...
class JogoDaVelha {
  ...
  #trocarJogador() {
    this.jogadorAtual = this.jogadorAtual.simbolo ===
      this.jogador1.simbolo ? this.jogador2 : this.jogador1;
  }
...
(function(){
  ...
  const novoJogo = (tamanho = 3) => {
    const jogo = new JogoDaVelha(new JogadorHumano('X'), new JogadorHumano('O'), tamanho);
    return jogo;
  }
